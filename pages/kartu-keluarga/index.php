...
<h2 class="page-header">Data Kartu Keluarga</h2>
...
<table class="table table-striped table-condensed table-hover" id="datatable" style="text-align: center">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: left;"><?php echo $kartu_keluarga['nomor_keluarga'] ?></td>
      <td style="text-align: left;"><?php echo $kartu_keluarga['nama_warga'] ?></td>
      <td style="text-align: left;"><?php echo $kartu_keluarga['nik_warga'] ?></td>
      <td><?php echo $jumlah_jumlah_anggota['total'] ?></td>
      <td style="text-align: left;"><?php echo $kartu_keluarga['alamat_keluarga'] ?></td>
